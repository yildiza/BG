...
/**
 * This is the item provider adapter for a {@link bg.microarc.microservices.WebUI} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WebUIItemProvider extends AuxiliaryElementsItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((WebUI) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_WebUI_type")
