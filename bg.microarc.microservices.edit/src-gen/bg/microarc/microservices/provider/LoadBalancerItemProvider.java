...
/**
 * This is the item provider adapter for a {@link bg.microarc.microservices.LoadBalancer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoadBalancerItemProvider extends AuxiliaryElementsItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((LoadBalancer) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_LoadBalancer_type")
